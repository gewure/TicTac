...
//						System.out.println("AI THINKING");
                        boardIndex = ((AIPlayer)p).getIndexToPlacePiece(game.gameBoard);
                        long endTime = System.nanoTime();
                        //					game.printGameBoard();
                        //TODO Logg
//                        Log.warn("Number of moves: "+((AIPlayer)p).numberOfMoves);
//                        Log.warn("Moves that removed: "+((AIPlayer)p).movesThatRemove);
...
//						System.out.println(p.getName()+" placed piece on "+boardIndex);
                    ...
                    if(game.placePieceOfPlayer(boardIndex, p.getPlayerToken())) {
                        ...
                        if(game.madeAMill(boardIndex, p.getPlayerToken())) {
                            ...
                            while(true) {
                                if(p.isAI()){
                                    boardIndex = ((AIPlayer)p).getIndexToRemovePieceOfOpponent(game.gameBoard);
...
//						long startTime = System.nanoTime();
                        //System.out.println("AI THINKING");
                        move = ((AIPlayer)p).getPieceMove(game.gameBoard, game.getCurrentGamePhase());
//						long endTime = System.nanoTime();
//						game.printGameBoard();
